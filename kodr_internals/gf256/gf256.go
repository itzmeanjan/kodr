/// This package is auto-generated using Grok, given contents of https://github.com/itzmeanjan/rlnc/blob/02bbf56f7e5291997e1d651288af52e6268969a2/src/common/gf256.rs as input.
...
// gf256_ORDER represents the order of the GF(2^8) field
const gf256_ORDER = 256

// gf256_LOG_TABLE is the logarithm table for GF(2^8)
var gf256_LOG_TABLE = [gf256_ORDER]uint8{
...
// gf256_EXP_TABLE is the exponentiation table for GF(2^8)
var gf256_EXP_TABLE = [2*gf256_ORDER - 2]uint8{
...
// Gf256 represents an element in GF(2^8)
type Gf256 struct {
	val uint8
}
...
// Get returns the raw uint8 value of the Gf256 element
func (g Gf256) Get() uint8 {
	return g.val
}
...
// PrimitiveElement returns primitive element x for GF(2^8) field
func PrimitiveElement() Gf256 {
	return Gf256{val: 2}
}
...
func (g Gf256) Inv() (Gf256, error) {
	...
	result := Gf256{
		val: gf256_EXP_TABLE[(gf256_ORDER-1)-gf256_LOG_TABLE[g.val]],
	}
	return result, nil
}

// Add performs addition (XOR) of two Gf256 elements
func (g Gf256) Add(other Gf256) Gf256 {
	return Gf256{val: g.val ^ other.val}
}

// AddAssign performs in-place addition (XOR)
func (g *Gf256) AddAssign(other Gf256) {
	g.val ^= other.val
}

// Neg computes the additive inverse (returns self as XOR is self-inverse)
func (g Gf256) Neg() Gf256 {
	return g
}

// Sub performs subtraction (XOR) of two Gf256 elements
func (g Gf256) Sub(other Gf256) Gf256 {
	return Gf256{val: g.val ^ other.val}
}

// Mul performs multiplication of two Gf256 elements using logarithm and exponentiation tables
func (g Gf256) Mul(other Gf256) Gf256 {
	if g == Zero() || other == Zero() {
		return Zero()
	}

	l := int(gf256_LOG_TABLE[g.val])
	r := int(gf256_LOG_TABLE[other.val])

	return Gf256{val: gf256_EXP_TABLE[l+r]}
}
...
// Equal checks for equality between two Gf256 elements
func (g Gf256) Equal(other Gf256) bool {
	return g.val == other.val
}

// Random generates a random Gf256 element
func Random() Gf256 {
	return Gf256{val: uint8(rand.Intn(256))}
}
